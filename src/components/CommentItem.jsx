  ...
  {comment.filePath && (
    <div className="mt-2">
      {isImage ? (
        <>
          <img 
            src={`https://localhost:7001${comment.filePath}`} 
            alt="attachment" 
          ...
          <FsLightbox
            toggler={toggler}
            sources={[`https://localhost:7001${comment.filePath}`]}
          />
        </>
      ) : (
        <a href={`https://localhost:7001${comment.filePath}`} target="_blank" rel="noreferrer" 
